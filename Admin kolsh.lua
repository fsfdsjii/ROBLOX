local owners = {"aldobonavino"} -- Are able to set admins who can ban/etc... using :pa name
local admins = {"aldobonavino"} -- Sets admins who can use ban/kick/admin or shutdown
